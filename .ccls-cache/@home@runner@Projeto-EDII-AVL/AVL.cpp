...
NodeAVL *AVL::Search(int id) const { return SearchInternal(m_Root, id); }
...
NodeAVL *AVL::Insert(int id, const std::string &data) {
  if (IsEmpty()) {
...
NodeAVL *AVL::InsertInternal(NodeAVL *node, NodeAVL *parent, int id,
...
void AVL::Remove(int id) { RemoveInternal(m_Root, id); }
